...
@section('content')
    <div class="flex flex-col justify-center items-center">
        <div class="w-64 h-64 md:w-1/2 flex-1 md:mt-32">
            <svg
                class="fill-current mr-4 w-full h-64"
                id="e43251fe-2b99-4b63-8176-d5da4893f038"
                data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                 width="1177.82" height="724.47" viewBox="0 0 1177.82 724.47"><title>under construction</title>
                <path
